 ...
 * @date 2018/1/6 20:27
 */
public interface HuobiRestTemplate {
    /**
     ...
     */
    <T> Result<T> getForBean(String url, ParameterizedTypeReference<Result<T>> responseType, Long uriVariables) throws RestClientException;
